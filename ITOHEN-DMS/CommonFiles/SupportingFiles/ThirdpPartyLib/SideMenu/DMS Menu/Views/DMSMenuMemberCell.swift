...
class UserGroupMemberCell: UITableViewCell {
    ...
    struct Constants {
        ...
        static let avatarSize = CGSize(width: 20.0, height: 20.0)
    }
...
//    }()
    ...
    lazy var stackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [iconImage, memberDetailsStackView])
    ...
    func setupConstraints() {
        ...
        let avatarWidthConstriant = iconImage.widthAnchor.constraint(equalToConstant: Constants.avatarSize.width)
        let avatarHeightConstraint = iconImage.heightAnchor.constraint(equalToConstant: Constants.avatarSize.height)
    ...
    override func setHighlighted(_ highlighted: Bool, animated: Bool) {
        ...
        iconImage.backgroundColor = presentable.avatarBackgroundColor
    }
    ...
    func configure(with presentable: UserGroupMemberPresentable) {
        ...
        imageView?.image = UIImage.init(named: "ic_addNewOrder")
