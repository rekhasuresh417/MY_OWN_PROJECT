...
public class SwiftDataTable: UIView {
    ...
    func registerObservers(){
        NotificationCenter.default.addObserver(self, selector: #selector(deviceOrientationWillChange),
...
extension SwiftDataTable: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, willDisplaySupplementaryView view: UICollectionReusableView, forElementKind elementKind: String, at indexPath: IndexPath) {
        ...
        default:
            // customized
            if indexPath[0] == dataStructure.columnCount-1{
                view.backgroundColor = UIColor.init(rgb: 0xF6F6F6)
            }else{
...
extension SwiftDataTable {
    ...
    fileprivate func applyDefaultColumnOrder(_ columnOrder: DataTableColumnOrder){
        ...
        self.sort(column: columnOrder.index, sort: .hidden) // Customized
    }
    ...
    func applyColumnOrder(_ columnOrder: DataTableColumnOrder){
        Array(0..<self.headerViewModels.count).forEach {
            self.headerViewModels[$0].sortType = .hidden // Customized - All headers sort type set to hidden
        }
    }
...
//        }
    ...
    func automaticWidthForColumn(index: Int) -> CGFloat {
        ...
        let sortingArrowVisualElementWidth: CGFloat = 0 // This is ugly // customized
