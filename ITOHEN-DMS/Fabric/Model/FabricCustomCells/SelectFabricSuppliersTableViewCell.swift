//
//  SelectFabricSuppliersTableViewCell.swift
//  ITOHEN-DMS
//
...
class SelectFabricSuppliersTableViewCell: UITableViewCell {
    ...
    func setContent(index: Int, data: FabricContactData, selectedData: [FabricContactData], tempSelectedData: [FabricContactData],  isSent: Bool = false, target: SelectFabricSuppliersVC?){
        ...
        self.selectSuppliersButton.setImage(containData.count > 0 ? UIImage.init(named: "checkbox_tick") : UIImage.init(named: "checkbox"), for: .normal)
