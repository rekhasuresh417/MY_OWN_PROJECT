//
//  GuestListTVCell.swift
//  Itohen-dms
//
//  Created by Dharma sheelan on 11/02/21.
//

import UIKit

class GuestListTVCell: UITableViewCell {
    ...
    func setContent(data:PartnerContactsData, target:GuestUserListVC?){
        ...
        self.roleLabel.text = target?.getGuestRoleForId(id: data.contactRole)
